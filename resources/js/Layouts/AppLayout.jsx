...
export default function AppLayout({ children, title }) {
    // Safe-destructure URL dari Inertia Page
    const page = usePage();
    const url = page?.url || '';
        ...
        <div className="min-h-screen bg-[#FAF4EB] font-sans text-slate-800 relative antialiased flex flex-col justify-between overflow-x-hidden">
            ...
            <header 
                className={`fixed w-full top-0 z-50 transition-all duration-300 border-b ${
                    scrolled 
                        ? 'bg-[#051736]/85 backdrop-blur-lg border-[#D4AF37]/30 shadow-2xl py-2.5' 
                        : 'bg-[#07327F]/75 backdrop-blur-md border-white/10 py-3.5'
                }`}
            >
                <nav className="container mx-auto px-6 flex justify-between items-center max-w-7xl relative">
                    
                    {/* Background Glass Sparkle Overlay */}
                    <div className="absolute left-0 top-0 bottom-0 w-32 pointer-events-none opacity-20 hidden lg:block">
                        <svg viewBox="0 0 100 100" fill="none" className="w-full h-full text-[#D4AF37]">
                            <path d="M0 0 C 50 0, 80 30, 80 100 L 0 100 Z" fill="currentColor" opacity="0.15"/>
                        </svg>
                    </div>
                    ...
                    <Link href="/" className="flex items-center space-x-3 group z-10">
                        ...
                        <span className="font-serif font-extrabold text-xl md:text-2xl text-white tracking-wide group-hover:text-[#F3E5AB] transition">
                            Attaufiq
                        </span>
                    </Link>

                    {/* Menu Navigasi Utama */}
                    <div className="hidden md:flex space-x-7 text-xs font-medium tracking-wide items-center z-10">
                        {navLinks.map((link) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    {/* Yellow Scribble Underline (Active Page) */}
                                    {isActive && (
                    ...
                    <div className="flex items-center z-10">
                        <Link 
                            href="/admission" 
                            className="bg-[#FFC72C] hover:bg-[#ffd34d] text-[#051736] px-6 py-2.5 rounded-full text-xs font-bold transition duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 flex items-center space-x-1.5"
                        >
            ...
            {/* ==========================================
                3. FLOATING DIAMOND BUTTONS
            ========================================== */}
            <div className="fixed right-6 bottom-10 z-[100] group flex items-center justify-center">
                <div className="grid grid-cols-2 gap-1 rotate-45 transform scale-90 hover:scale-100 transition duration-500 ease-out cursor-pointer shadow-2xl rounded-2xl p-1 bg-[#07327F]/30 backdrop-blur-md border border-[#D4AF37]/40">

                    <Link href="/faq" className="w-13 h-13 sm:w-14 sm:h-14 bg-[#FFC72C] rounded-xl flex items-center justify-center shadow-md hover:-translate-x-1 hover:-translate-y-1 transition duration-300">
                        <div className="-rotate-45 flex flex-col items-center gap-0.5 text-[#051736]">
                            <Info className="w-4 h-4" strokeWidth={2.5} />
                            <span className="font-bold text-[9px] uppercase leading-none">INFO</span>
                        </div>
                    </Link>

                    <Link href="/admission" className="w-13 h-13 sm:w-14 sm:h-14 bg-[#008144] rounded-xl flex items-center justify-center shadow-md hover:translate-x-1 hover:-translate-y-1 transition duration-300 relative group/icon">
                        <div className="-rotate-45 flex flex-col items-center gap-0.5 text-white">
                            <UserPlus className="w-4 h-4" strokeWidth={2.5} />
                            <span className="font-black text-[9px] uppercase tracking-wider leading-none">DAFTAR</span>
                        </div>
                    </Link>

                    <a href="https://wa.me/6285268797915" target="_blank" rel="noreferrer" className="w-13 h-13 sm:w-14 sm:h-14 bg-[#07327F] rounded-xl flex items-center justify-center shadow-md hover:-translate-x-1 hover:translate-y-1 transition duration-300 border border-[#D4AF37]/40">
                        <div className="-rotate-45 flex flex-col items-center gap-0.5 text-white">
                            <MessageCircleQuestion className="w-4 h-4" strokeWidth={2.5} />
                            <span className="font-black text-[9px] uppercase tracking-wider leading-none">TANYA</span>
                        </div>
                    </a>

                    <a href="#footer-location" className="w-13 h-13 sm:w-14 sm:h-14 bg-[#D4AF37] rounded-xl flex items-center justify-center shadow-md hover:translate-x-1 hover:translate-y-1 transition duration-300">
                        <div className="-rotate-45 flex flex-col items-center gap-0.5 text-[#051736]">
                            <MapPin className="w-4 h-4" strokeWidth={2.5} />
                            <span className="font-black text-[9px] uppercase tracking-wider leading-none">LOKASI</span>
                        </div>
                    </a>
            ...
            {/* ==========================================
                4. FOOTER ROYAL BLUE DOME (WITH NATIVE SVG SOSMED)
            ========================================== */}
            <footer id="footer-location" className="relative bg-[#FAF4EB] text-white pt-10 overflow-hidden font-sans">
                
                <div className="container mx-auto px-4 max-w-7xl relative z-10">
                    <div className="relative bg-[#003B99] rounded-t-[50px] md:rounded-t-[80px] border-t-2 border-x-2 border-[#D4AF37] p-8 md:p-12 overflow-hidden shadow-2xl">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-6 relative z-10 items-start pt-6">
                            ...
                            {/* COL 2: Alamat PG-TK-SD & SMP-SMA */}
                            <div className="lg:col-span-3 space-y-5 lg:border-r border-blue-400/30 pr-0 lg:pr-4">
                            ...
                            {/* COL 4: Follow Us (Native SVG Icons) */}
