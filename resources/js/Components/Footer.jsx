...
const KONTAK_ROWS = [
    ...
    { Icon: InstagramIcon, text: "@attaufiq_jambi", href: "https://www.instagram.com/attaufiq_jambi/", size: 24 },
...
const SOCIAL_ICONS = [
    {
        Icon: FacebookIcon,
        label: "Facebook",
        href: "https://www.facebook.com/sekolahattaufiqjambi"
    },
    {
        Icon: InstagramIcon,
        label: "Instagram",
        href: "https://www.instagram.com/attaufiq_jambi/"
    },
    {
        Icon: YoutubeIcon,
        label: "YouTube",
        href: "https://www.youtube.com/@attaufiq_jambi"
    },
    {
        Icon: TiktokIcon,
        label: "TikTok",
        href: "https://www.tiktok.com/@attaufiq_jambi"
    },
];
          ...
          stretch is always uniform regardless of viewport width. */}
            ...
            spills out past the arch's inner edge. */}
                ...
                than dotted. Missed entirely in the first pass. */}
                    ...
                    {/* Ganti elemen div render SOCIAL_ICONS sebelumnya dengan ini: */}
